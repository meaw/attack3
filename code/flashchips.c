...
.voltage = { 2700, 3600 },
	...
	{
		.vendor = "SPANSION",
		.name = "S25FL512S", /* ..3E = 3V, uniform 64KB/4KB blocks/sectors */
		.bustype = BUS_SPI,
		...
		.page_size = 256,
		/* supports SFDP */
		/* OTP: 1024B total; read 0x4B, write 0x42 */
		.feature_bits = FEATURE_WRSR_WREN | FEATURE_OTP | FEATURE_QPI
		| FEATURE_4BA_SUPPORT,
...
{
	{
	 ...
	 .eraseblocks = { {65536 * 1024, 1} },
	 .block_erase = spi_block_erase_c7_4ba,
	 }*/
},
.printlock = spi_prettyprint_status_register_bp2_ep_srwd, /* TODO: config, lock, flag regs */
.unlock = spi_disable_blockprotect_bp2_srwd, /* TODO: per 64kB sector lock registers */
.write = spi_chip_write_256, /* Multi I/O supported */
.read = spi_chip_read, /* Fast read (0x0B) and multi I/O supported */
.voltage = { 2700, 3600 },
